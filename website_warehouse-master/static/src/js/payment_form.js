odoo.define('websitesale_warehouse.payment_form', function (require) {
    "use strict";
    ...
    var PaymentForm = Payment.include({
                ...
                // if the user is going to pay with a form payment, then
                    ...
                    if ($tx_url.length === 1) {
                        ...
                        return ajax.jsonRpc($tx_url[0].value, 'call', {
                            ...
                            'warehouse': parseInt($('select[name=field1] option:selected').val()),
